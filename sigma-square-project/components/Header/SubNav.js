...
const SubNav = () => {
  return (
    <nav className="flex justify-center">
      <div className="absolute container mx-auto px-4 gap-10 flex items-center justify-center pt-16">
        <Image src={Sigma_Logo_2} style={{ width: "100px" }} />
        <div className="flex justify-between rounded-full bg-[#6F6657] px-3 text-[#FEFCF9]">
